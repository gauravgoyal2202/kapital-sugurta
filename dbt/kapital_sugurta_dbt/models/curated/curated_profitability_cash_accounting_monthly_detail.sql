...
dimension_keys AS (
    SELECT month_start_date, branch_name, branch_name_uz, product_name, product_name_uz, insurance_type, product_category, product_category_uz
...
SELECT
    ...
    0::NUMERIC                                                          AS outgoing_reinsurance_premium_uzs
...
ORDER BY ms.month_start_date, dk.branch_name, dk.product_name
