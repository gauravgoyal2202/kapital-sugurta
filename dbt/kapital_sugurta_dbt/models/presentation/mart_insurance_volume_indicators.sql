...
company_agg AS (
    ...
    SELECT
        ...
        COALESCE(NULLIF(pd.category, 'Unclassified'), 'пустой') AS category,
        COALESCE(NULLIF(pd.category_ru, 'Unclassified'), 'пустой') AS category_ru,
        COALESCE(NULLIF(pd.category_uz, 'Unclassified'), 'пустой') AS category_uz,
        COALESCE(NULLIF(pd.category_uz_latn, 'Unclassified'), 'пустой') AS category_uz_latn,
        COALESCE(NULLIF(pd.product_name, 'Unknown Product'), 'пустой') AS product_name,
        COALESCE(NULLIF(pd.product_name_ru, 'Unknown Product'), 'пустой') AS product_name_ru,
        COALESCE(NULLIF(pd.product_name_uz, 'Unknown Product'), 'пустой') AS product_name_uz,
        COALESCE(NULLIF(pd.product_name_uz_latn, 'Unknown Product'), 'пустой') AS product_name_uz_latn,
